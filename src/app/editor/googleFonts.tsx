...
export function GoogleFontsPicker({ addFont }: { addFont: (font: string) => void }) {
        ...
        <>
            ...
            <dialog ref={dialogRef} className={classes.dialog}>
                ...
                <div className={classes.categorySelector}>
                    ...
                    <label className={category === "display" ? classes.checked : undefined} style={{ fontFamily: "fancy" }}><input type="radio" name="category" value="display" checked={category === "display"} onChange={onCategoryChange} />Display</label>
                    <label className={category === "handwriting" ? classes.checked : undefined} style={{ fontFamily: "cursive" }}><input type="radio" name="category" value="handwriting" checked={category === "handwriting"} onChange={onCategoryChange} />Handwriting</label>
